...
// Set url in a constant variable
...
function init() {
    ...
    d3.json(url).then((data) => {
        ...
        // Set variable for names in sample
        let names = data.names;

        // Add samples to dropdown menu
        names.forEach((id) => {

            // Log id for each iteration
            console.log(id);
...
function buildMetadata(sample) {
    ...
    d3.json(url).then((data) => {
        ...
        // Log the metadata objects after filtering
        console.log(value)
        ...
        // Use Object.entries to add every value pair 
        Object.entries(valueData).forEach(([key,value]) => {

            // Log value pairs from the metadata
...
function buildBubbleChart(sample) {
    ...
    d3.json(url).then((data) => {
        ...
        // Plot the bubble chart uisng plotly
...
function buildGaugeChart(sample) {
    ...
    d3.json(url).then((data) => {
        ...
        // Log the metadata after the have been filtered
        console.log(value)
...
// Function to update dashboard based on sample selection
